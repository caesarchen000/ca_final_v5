...
namespace gem5
{
namespace gem5_ruby_MI_example_Directory_Controller_create
{
...
template<>
struct [[deprecated(
        "Warning: MI_example_Directory_Controller is not constructible from MI_example_Directory_ControllerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MI_example_Directory_Controller has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::MI_example::Directory_Controller,
                             const MI_example_Directory_ControllerParams &>> warning_instance;
} // namespace gem5_ruby_MI_example_Directory_Controller_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_LupioBLK_create
{
...
template<>
struct [[deprecated(
        "Warning: LupioBLK is not constructible from LupioBLKParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is LupioBLK has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::LupioBLK,
                             const LupioBLKParams &>> warning_instance;
} // namespace gem5_LupioBLK_create
} // namespace gem5

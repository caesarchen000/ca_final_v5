...
namespace gem5
{
namespace gem5_RiscvISA_MMU_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvMMU is not constructible from RiscvMMUParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvMMU has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvISA::MMU,
                             const RiscvMMUParams &>> warning_instance;
} // namespace gem5_RiscvISA_MMU_create
} // namespace gem5

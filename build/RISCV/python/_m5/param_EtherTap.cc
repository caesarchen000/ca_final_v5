...
namespace gem5
{
namespace gem5_EtherTap_create
{
...
template<>
struct [[deprecated(
        "Warning: EtherTap is not constructible from EtherTapParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is EtherTap has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::EtherTap,
                             const EtherTapParams &>> warning_instance;
} // namespace gem5_EtherTap_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_RiscvISA_FsLinux_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvLinux is not constructible from RiscvLinuxParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvLinux has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvISA::FsLinux,
                             const RiscvLinuxParams &>> warning_instance;
} // namespace gem5_RiscvISA_FsLinux_create
} // namespace gem5

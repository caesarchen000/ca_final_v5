...
namespace gem5
{
namespace gem5_RiscvRTC_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvRTC is not constructible from RiscvRTCParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvRTC has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvRTC,
                             const RiscvRTCParams &>> warning_instance;
} // namespace gem5_RiscvRTC_create
} // namespace gem5

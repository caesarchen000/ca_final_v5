...
namespace gem5
{
namespace gem5_HiFiveBase_create
{
...
template<>
struct [[deprecated(
        "Warning: HiFiveBase is not constructible from HiFiveBaseParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is HiFiveBase has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::HiFiveBase,
                             const HiFiveBaseParams &>> warning_instance;
} // namespace gem5_HiFiveBase_create
} // namespace gem5

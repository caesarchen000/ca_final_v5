...
namespace gem5
{
namespace gem5_RiscvISA_Decoder_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvDecoder is not constructible from RiscvDecoderParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvDecoder has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvISA::Decoder,
                             const RiscvDecoderParams &>> warning_instance;
} // namespace gem5_RiscvISA_Decoder_create
} // namespace gem5

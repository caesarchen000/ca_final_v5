...
namespace gem5
{
namespace gem5_RiscvSemihosting_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvSemihosting is not constructible from RiscvSemihostingParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvSemihosting has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvSemihosting,
                             const RiscvSemihostingParams &>> warning_instance;
} // namespace gem5_RiscvSemihosting_create
} // namespace gem5

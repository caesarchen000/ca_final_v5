...
namespace gem5
{
namespace gem5_RiscvISA_BootloaderKernelWorkload_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvBootloaderKernelWorkload is not constructible from RiscvBootloaderKernelWorkloadParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvBootloaderKernelWorkload has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvISA::BootloaderKernelWorkload,
                             const RiscvBootloaderKernelWorkloadParams &>> warning_instance;
} // namespace gem5_RiscvISA_BootloaderKernelWorkload_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_RiscvISA_TLB_create
{
...
template<>
struct [[deprecated(
        "Warning: RiscvTLB is not constructible from RiscvTLBParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RiscvTLB has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvISA::TLB,
                             const RiscvTLBParams &>> warning_instance;
} // namespace gem5_RiscvISA_TLB_create
} // namespace gem5

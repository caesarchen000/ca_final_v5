...
namespace gem5
{
namespace gem5_RiscvISA_PMAChecker_create
{
...
template<>
struct [[deprecated(
        "Warning: PMAChecker is not constructible from PMACheckerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PMAChecker has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RiscvISA::PMAChecker,
                             const PMACheckerParams &>> warning_instance;
} // namespace gem5_RiscvISA_PMAChecker_create
} // namespace gem5

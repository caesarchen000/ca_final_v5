...
L1Cache_Controller::b_issuePUT(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:286: %s for machine %s.\n", "assert failure", name());
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:299: %s for machine %s.\n", "assert failure", name());
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:313: %s for machine %s.\n", "assert failure", name());
...
L1Cache_Controller::r_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:361: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:369: %s for machine %s.\n", "assert failure", name());
...
L1Cache_Controller::s_store_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:377: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:385: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:394: %s for machine %s.\n", "assert failure", name());
...
L1Cache_Controller::x_copyDataFromCacheToTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:417: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:418: %s for machine %s.\n", "assert failure", name());
            ...
            if ((param_type == RubyRequestType_IFETCH)) {
                return L1Cache_Event_Ifetch;
                    ...
                    if (((param_type == RubyRequestType_ST) || (param_type == RubyRequestType_ATOMIC))) {
                        ...
                        panic("Runtime Error at MI_example-cache.sm:128: %s for machine %s.\n", ("Invalid RubyRequestType"), name());
                        ;
                    }
                }
            }

...
DMA_Controller::t_updateTBEData(DMA_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-dma.sm:172: %s for machine %s.\n", "assert failure", name());
...
{
panic("Runtime Error at MI_example-dma.sm:96: %s for machine %s.\n", ("DMA does not support functional read."), name());
;
...
{
panic("Runtime Error at MI_example-dma.sm:100: %s for machine %s.\n", ("DMA does not support functional write."), name());
;
